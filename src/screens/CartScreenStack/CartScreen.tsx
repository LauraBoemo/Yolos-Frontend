...
import {Image, SafeAreaView, ScrollView, View, ImageBackground, TouchableOpacity} from "react-native";
    ...
    return (
        <View style={{flex: 1}}>
            ...
            <View style={{alignItems: 'center'}}>
                    <TouchableOpacity onPress={(): void => navigate('create user tickets')}>
